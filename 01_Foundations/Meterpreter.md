...
- `getpid` = for show the pid meterpreter proses on target exploit
- `ps` = for show PID prosess on terget exploit
- `migrate [PD ps]` = for move proses meterpreter in target for hight exclamation
